...
Now let us consider $d=2n$, then note that in $x^iy^j$ we have either $i>n$ or $j>n$, thus either $x^i \in \mfrk a$ or $x^j \in \mfrk a$; so we have that $S_d\subseteq \mfrk a$.\par
